...
Motion::Project::App.setup do |app|
  ...
  # ===========================================================================================
  app.identifier = 'com.michaeljacobson.rubymotiontest'
  ...
  #    see there below.
  # ===========================================================================================
  app.codesign_certificate = 'iPhone Developer: michael.jacobson89@gmail.com (WZ6R7K5V9C)'
  ...
  # ===========================================================================================
  app.provisioning_profile = './RubyMotion_Test_Profile.mobileprovision'
